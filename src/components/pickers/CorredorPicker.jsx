    ...
    <>
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex-1 text-left border rounded-xl px-3 py-2 bg-white dark:bg-slate-800 dark:text-slate-100 dark:border-slate-600 text-sm cursor-pointer"
        >
          {effectiveSelected ? (
            ...
            <div className="space-y-2">
              {corredores.map((c) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 rounded-xl border p-3 text-left transition cursor-pointer hover:-translate-y-0.5 hover:shadow-md dark:bg-slate-800 ${value == c.id
